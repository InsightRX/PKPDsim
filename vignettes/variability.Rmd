...
will simulate out data for 50 patients, assuming an Omega matrix as defined above. 
Alternatively, the coefficient of variation can be specified (assuming no correlation between parameters):
